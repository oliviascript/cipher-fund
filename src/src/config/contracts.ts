export const FUNDRAISING_ADDRESS = '0x0000000000000000000000000000000000000000';
...
export const FUNDRAISING_ABI = [
  ...
  {
    "inputs": [],
    "name": "InvalidCampaignGoal",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "InvalidDonationPayload",
    "type": "error"
  },
  {
    "inputs": [
    ...
    "outputs": [
      {
        ...
        "internalType": "struct ConfidentialFundraising.CampaignInfo",
        "name": "",
        "type": "tuple"
      }
    ],
